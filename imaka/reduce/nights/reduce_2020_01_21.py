...
fnum_c_4F_1 = [82, 84, 86, 88, 90, 92]
fnum_c_4F_1 = [106, 108, 110, 112, 114]
...
def reduce_beehive():
    ...
    reduce_fli.clean_images(scan_img_files, out_dir, rebin=1, sky_frame=sky_dir + 'beehive_sky.fits', flat_frame=flat_dir+"flat.fits")
