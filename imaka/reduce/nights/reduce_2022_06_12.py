...
dict_images = {'LS_3L': [5,9,13,17,21,25,29,33,37,41,50,54,58,62,66,70,74],
               'open':  [6,10,14,18,22,26,30,34,38,42,51,55,59,63,67,71,75],
               'TT_3':  [7,11,15,19,23,27,31,35,39,43,52,56,69,64,68,71,76],
               'LS_3Lb':[8,12,16,20,24,28,32,36,40,44,53,57,61,65,69,73,77],
              }
...
def make_dark():
    ...
    ## COPY FROM OLD NIGHT
    print("Copying: 20220609 I dark (120)")
