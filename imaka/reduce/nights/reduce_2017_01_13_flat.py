...
def plot_stats():
    ...
    so = table.Table.read(stats_dir + 'stats_open.fits')
    st = table.Table.read(stats_dir + 'stats_ttf.fits')
    sc = table.Table.read(stats_dir + 'stats_closed.fits')
    ...
    plt.ylim(0, 1.3)
    plt.savefig(plots_dir + 'fwhm_ratio_vs_frame.png')
    ...
    plt.axhline(1.0, color='k', linestyle='--', linewidth=2)
    plt.ylim(0, 1.3)
    plt.savefig(plots_dir + 'ee50_ratio_vs_frame.png')
    ...
    plt.axhline(1.0, color='k', linestyle='--', linewidth=2)
    plt.ylim(0, 1.3)
    plt.savefig(plots_dir + 'ee80_ratio_vs_frame.png')
    ...
    plt.axhline(1.0, color='k', linestyle='--', linewidth=2)
    plt.ylim(0, 1.3)
    plt.savefig(plots_dir + 'nea_ratio_vs_frame.png')
    ...
    plt.axhline(1.0, color='k', linestyle='--', linewidth=2)
    plt.ylim(0, 1.3)
    plt.savefig(plots_dir + 'nea2_ratio_vs_frame.png')
    ...
    plt.axhline(1.0, color='k', linestyle='--', linewidth=2)
    plt.ylim(0, 1.3)
    plt.savefig(plots_dir + 'xyfwhm_ratio_vs_frame.png')
